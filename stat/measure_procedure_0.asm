...
0000000000400780 <_start>:
  ...
  40078d:	50                   	push   %rax
  40078e:	54                   	push   %rsp
  40078f:	49 c7 c0 10 11 40 00 	mov    $0x401110,%r8
  400796:	48 c7 c1 a0 10 40 00 	mov    $0x4010a0,%rcx
...
0000000000400852 <cal_variance>:
  ...
  4008fa:	66 0f 2f 05 fe 09 00 	comisd 0x9fe(%rip),%xmm0        # 401300 <BOUND_OF_LOOP+0xa0>
  400901:	00 
  ...
  40090b:	f2 0f 10 0d ed 09 00 	movsd  0x9ed(%rip),%xmm1        # 401300 <BOUND_OF_LOOP+0xa0>
  400912:	00 
...
000000000040092b <do_calculation>:
  ...
  4009d3:	be 28 11 40 00       	mov    $0x401128,%esi
  ...
  4009eb:	bf 2a 11 40 00       	mov    $0x40112a,%edi
  ...
  400a10:	bf 40 11 40 00       	mov    $0x401140,%edi
  ...
  400a6e:	be 87 11 40 00       	mov    $0x401187,%esi
  ...
  400c7f:	bf a8 11 40 00       	mov    $0x4011a8,%edi
  ...
  400c93:	be f0 11 40 00       	mov    $0x4011f0,%esi
  ...
  400cb0:	be 17 12 40 00       	mov    $0x401217,%esi
  ...
  400ccd:	be 21 12 40 00       	mov    $0x401221,%esi
  ...
  400ced:	be 2f 12 40 00       	mov    $0x40122f,%esi
  ...
  400d0a:	be 45 12 40 00       	mov    $0x401245,%esi
...
0000000000400dd6 <main>:
  ...
  400e0f:	bf 68 12 40 00       	mov    $0x401268,%edi
  400e14:	e8 b7 f8 ff ff       	callq  4006d0 <puts@plt>
  400e19:	b8 00 00 00 00       	mov    $0x0,%eax
  400e1e:	e9 5c 02 00 00       	jmpq   40107f <main+0x2a9>
  ...
  400e7c:	bf 90 12 40 00       	mov    $0x401290,%edi
  ...
  400ec4:	e9 b6 01 00 00       	jmpq   40107f <main+0x2a9>
  ...
  400ee2:	e9 a0 00 00 00       	jmpq   400f87 <main+0x1b1>
  400ee7:	c7 45 94 00 00 00 00 	movl   $0x0,-0x6c(%rbp)
  400eee:	e9 82 00 00 00       	jmpq   400f75 <main+0x19f>
  400ef3:	0f a2                	cpuid  
  400ef5:	0f 31                	rdtsc  
  ...
  400f01:	b8 00 00 00 00       	mov    $0x0,%eax
  400f06:	e8 27 fe ff ff       	callq  400d32 <procedure_0>
  400f0b:	0f 01 f9             	rdtscp 
  400f0e:	89 d7                	mov    %edx,%edi
  400f10:	89 c6                	mov    %eax,%esi
  400f12:	0f a2                	cpuid  
  400f14:	89 7d a0             	mov    %edi,-0x60(%rbp)
  400f17:	89 75 a4             	mov    %esi,-0x5c(%rbp)
  400f1a:	8b 45 98             	mov    -0x68(%rbp),%eax
  400f1d:	48 c1 e0 20          	shl    $0x20,%rax
  400f21:	48 89 c2             	mov    %rax,%rdx
  400f24:	8b 45 9c             	mov    -0x64(%rbp),%eax
  400f27:	48 09 d0             	or     %rdx,%rax
  400f2a:	48 89 45 d8          	mov    %rax,-0x28(%rbp)
  400f2e:	8b 45 a0             	mov    -0x60(%rbp),%eax
  400f31:	48 c1 e0 20          	shl    $0x20,%rax
  400f35:	48 89 c2             	mov    %rax,%rdx
  400f38:	8b 45 a4             	mov    -0x5c(%rbp),%eax
  400f3b:	48 09 d0             	or     %rdx,%rax
  400f3e:	48 89 45 e0          	mov    %rax,-0x20(%rbp)
  400f42:	8b 45 90             	mov    -0x70(%rbp),%eax
  400f45:	48 98                	cltq   
  400f47:	48 8d 14 c5 00 00 00 	lea    0x0(,%rax,8),%rdx
  400f4e:	00 
  400f4f:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  400f53:	48 01 d0             	add    %rdx,%rax
  400f56:	48 8b 00             	mov    (%rax),%rax
  400f59:	8b 55 94             	mov    -0x6c(%rbp),%edx
  400f5c:	48 63 d2             	movslq %edx,%rdx
  400f5f:	48 c1 e2 03          	shl    $0x3,%rdx
  400f63:	48 01 c2             	add    %rax,%rdx
  400f66:	48 8b 45 e0          	mov    -0x20(%rbp),%rax
  400f6a:	48 2b 45 d8          	sub    -0x28(%rbp),%rax
  400f6e:	48 89 02             	mov    %rax,(%rdx)
  400f71:	83 45 94 01          	addl   $0x1,-0x6c(%rbp)
  400f75:	b8 64 00 00 00       	mov    $0x64,%eax
  400f7a:	39 45 94             	cmp    %eax,-0x6c(%rbp)
  400f7d:	0f 8c 70 ff ff ff    	jl     400ef3 <main+0x11d>
  400f83:	83 45 90 01          	addl   $0x1,-0x70(%rbp)
  400f87:	b8 64 00 00 00       	mov    $0x64,%eax
  400f8c:	39 45 90             	cmp    %eax,-0x70(%rbp)
  400f8f:	0f 8e 52 ff ff ff    	jle    400ee7 <main+0x111>
  400f95:	48 c7 45 a8 00 00 00 	movq   $0x0,-0x58(%rbp)
  400f9c:	00 
  400f9d:	48 c7 45 b0 00 00 00 	movq   $0x0,-0x50(%rbp)
  400fa4:	00 
  400fa5:	48 c7 45 b8 00 00 00 	movq   $0x0,-0x48(%rbp)
  400fac:	00 
  400fad:	48 c7 45 c0 00 00 00 	movq   $0x0,-0x40(%rbp)
  400fb4:	00 
  400fb5:	48 c7 45 d0 bb 12 40 	movq   $0x4012bb,-0x30(%rbp)
  400fbc:	00 
  400fbd:	41 bb 64 00 00 00    	mov    $0x64,%r11d
  400fc3:	41 ba 64 00 00 00    	mov    $0x64,%r10d
  400fc9:	48 8b 45 c8          	mov    -0x38(%rbp),%rax
  400fcd:	48 8d 78 08          	lea    0x8(%rax),%rdi
  400fd1:	48 8d 75 b8          	lea    -0x48(%rbp),%rsi
  400fd5:	48 8d 4d b0          	lea    -0x50(%rbp),%rcx
  400fd9:	48 8d 45 a8          	lea    -0x58(%rbp),%rax
  400fdd:	ff 75 d0             	pushq  -0x30(%rbp)
  400fe0:	48 8d 55 c0          	lea    -0x40(%rbp),%rdx
  400fe4:	52                   	push   %rdx
  400fe5:	49 89 f1             	mov    %rsi,%r9
  400fe8:	49 89 c8             	mov    %rcx,%r8
  400feb:	48 89 c1             	mov    %rax,%rcx
  400fee:	44 89 da             	mov    %r11d,%edx
  400ff1:	44 89 d6             	mov    %r10d,%esi
  400ff4:	e8 32 f9 ff ff       	callq  40092b <do_calculation>
  400ff9:	48 83 c4 10          	add    $0x10,%rsp
  400ffd:	bf d8 12 40 00       	mov    $0x4012d8,%edi
  401002:	e8 c9 f6 ff ff       	callq  4006d0 <puts@plt>
  401007:	ba 64 00 00 00       	mov    $0x64,%edx
  40100c:	b8 64 00 00 00       	mov    $0x64,%eax
  401011:	89 c6                	mov    %eax,%esi
  401013:	bf f0 11 40 00       	mov    $0x4011f0,%edi
  401018:	b8 00 00 00 00       	mov    $0x0,%eax
  40101d:	e8 de f6 ff ff       	callq  400700 <printf@plt>
  401022:	48 8b 45 a8          	mov    -0x58(%rbp),%rax
  401026:	48 89 c6             	mov    %rax,%rsi
  401029:	bf 17 12 40 00       	mov    $0x401217,%edi
  40102e:	b8 00 00 00 00       	mov    $0x0,%eax
  401033:	e8 c8 f6 ff ff       	callq  400700 <printf@plt>
  401038:	48 8b 45 b0          	mov    -0x50(%rbp),%rax
  40103c:	48 89 c6             	mov    %rax,%rsi
  40103f:	bf 21 12 40 00       	mov    $0x401221,%edi
  401044:	b8 00 00 00 00       	mov    $0x0,%eax
  401049:	e8 b2 f6 ff ff       	callq  400700 <printf@plt>
  40104e:	48 8b 45 b8          	mov    -0x48(%rbp),%rax
  401052:	48 89 c6             	mov    %rax,%rsi
  401055:	bf 2f 12 40 00       	mov    $0x40122f,%edi
  40105a:	b8 00 00 00 00       	mov    $0x0,%eax
  40105f:	e8 9c f6 ff ff       	callq  400700 <printf@plt>
  401064:	48 8b 45 c0          	mov    -0x40(%rbp),%rax
  401068:	48 89 c6             	mov    %rax,%rsi
  40106b:	bf 45 12 40 00       	mov    $0x401245,%edi
  401070:	b8 00 00 00 00       	mov    $0x0,%eax
  401075:	e8 86 f6 ff ff       	callq  400700 <printf@plt>
  40107a:	b8 00 00 00 00       	mov    $0x0,%eax
  40107f:	48 8b 5d e8          	mov    -0x18(%rbp),%rbx
  401083:	64 48 33 1c 25 28 00 	xor    %fs:0x28,%rbx
  40108a:	00 00 
  40108c:	74 05                	je     401093 <main+0x2bd>
  40108e:	e8 5d f6 ff ff       	callq  4006f0 <__stack_chk_fail@plt>
  401093:	48 8b 5d f8          	mov    -0x8(%rbp),%rbx
  401097:	c9                   	leaveq 
  401098:	c3                   	retq   
...
00000000004010a0 <__libc_csu_init>:
  ...
  4010a4:	41 89 ff             	mov    %edi,%r15d
  4010a7:	41 55                	push   %r13
  4010a9:	41 54                	push   %r12
  4010ab:	4c 8d 25 46 0d 20 00 	lea    0x200d46(%rip),%r12        # 601df8 <__frame_dummy_init_array_entry>
  4010b2:	55                   	push   %rbp
  4010b3:	48 8d 2d 46 0d 20 00 	lea    0x200d46(%rip),%rbp        # 601e00 <__init_array_end>
  4010ba:	53                   	push   %rbx
  4010bb:	49 89 f6             	mov    %rsi,%r14
  4010be:	49 89 d5             	mov    %rdx,%r13
  4010c1:	4c 29 e5             	sub    %r12,%rbp
  4010c4:	48 83 ec 08          	sub    $0x8,%rsp
  4010c8:	48 c1 fd 03          	sar    $0x3,%rbp
  4010cc:	e8 b7 f5 ff ff       	callq  400688 <_init>
  4010d1:	48 85 ed             	test   %rbp,%rbp
  4010d4:	74 20                	je     4010f6 <__libc_csu_init+0x56>
  4010d6:	31 db                	xor    %ebx,%ebx
  4010d8:	0f 1f 84 00 00 00 00 	nopl   0x0(%rax,%rax,1)
  4010df:	00 
  4010e0:	4c 89 ea             	mov    %r13,%rdx
  4010e3:	4c 89 f6             	mov    %r14,%rsi
  4010e6:	44 89 ff             	mov    %r15d,%edi
  4010e9:	41 ff 14 dc          	callq  *(%r12,%rbx,8)
  4010ed:	48 83 c3 01          	add    $0x1,%rbx
  4010f1:	48 39 eb             	cmp    %rbp,%rbx
  4010f4:	75 ea                	jne    4010e0 <__libc_csu_init+0x40>
  4010f6:	48 83 c4 08          	add    $0x8,%rsp
  4010fa:	5b                   	pop    %rbx
  4010fb:	5d                   	pop    %rbp
  4010fc:	41 5c                	pop    %r12
  4010fe:	41 5d                	pop    %r13
  401100:	41 5e                	pop    %r14
  401102:	41 5f                	pop    %r15
  401104:	c3                   	retq   
  401105:	90                   	nop
...
0000000000401110 <__libc_csu_fini>:
  401110:	f3 c3                	repz retq 

Disassembly of section .fini:

0000000000401114 <_fini>:
  401114:	48 83 ec 08          	sub    $0x8,%rsp
